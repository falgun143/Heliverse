...
import { AppBar as MuiAppBar, Box, CssBaseline, Divider, Drawer, IconButton, List, ListItem, ListItemButton, ListItemIcon, ListItemText, Toolbar, Button } from '@mui/material';
...
export default function AppBar({ children }: { children: React.ReactNode },props:Props) {
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      >
        <Toolbar   sx={{display:"flex",justifyContent:{
          ...
          <Button  variant="contained"  style={{borderRadius:5}}  onClick={()=>{
            router.push("/login")
          }} >
            Login
          </Button>
